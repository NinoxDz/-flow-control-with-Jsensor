...
public class Data extends Message{
   ...
   // int [] shortPath = new int[5000];
    ...
    public Data(Node sender, Node destination, int hops, String message, short chunk) {
    ...
    private Data(String msg, Node sender, Node destination, int hops, long ID, ArrayList<Integer> ar) {
    	//Call to set the ID
    	this.setID(ID);
    	this.msg = msg;
        this.sender = sender;
    ...
    public Message clone() {
        return new Data(msg, sender, destination, hops+1,this.getID(),shortPath);
    }
}